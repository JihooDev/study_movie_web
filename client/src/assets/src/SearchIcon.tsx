...
export default function SearchIcon({ color = COLORS.white, size = 32 }: IconTypes) {
    return (
        <svg width={`${size}`} height={`${size}`} viewBox="0 0 24 24" fill='none' xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M20.9999 20.9999L16.6499 16.6499" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
